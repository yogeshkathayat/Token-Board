...
const WidgetsIcon = (
  <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
    <path d="M3 4a1 1 0 011-1h5a1 1 0 011 1v5a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm8 0a1 1 0 011-1h5a1 1 0 011 1v5a1 1 0 01-1 1h-5a1 1 0 01-1-1V4zm-8 8a1 1 0 011-1h5a1 1 0 011 1v5a1 1 0 01-1 1H4a1 1 0 01-1-1v-5zm8 0a1 1 0 011-1h5a1 1 0 011 1v5a1 1 0 01-1 1h-5a1 1 0 01-1-1v-5z" />
  </svg>
);
const SettingsIcon = (
  <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
...
const NAV: NavSection[] = [
  {
    heading: 'General',
    items: [
      { to: '/dashboard', label: 'Tokens', icon: DashboardIcon },
      { to: '/limits', label: 'Limits', icon: LimitsIcon },
  ...
  },
  {
    heading: 'Tools',
    items: [
      { to: '/widgets', label: 'macOS Widget', icon: WidgetsIcon },
    ],
  },
  {
    heading: 'Account',
  ...
  return (
    <div className="flex h-full">
      <aside className="hidden w-60 shrink-0 flex-col border-r border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900 md:flex">
        ...
        <div className="mt-6 rounded-lg bg-gradient-to-br from-brand-50 to-cyan-50 p-3 text-xs text-slate-600 dark:from-brand-900/30 dark:to-cyan-900/20 dark:text-slate-300">
